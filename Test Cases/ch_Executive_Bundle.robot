*** Settings ***
Documentation       Check Application -Executive Bundle
# Suite Teardown    Close Browser
Library             Selenium2Library
Resource            ../check_url.robot
Resource            ../actions/checks/ch_1_personal_details_executive.robot
...
Resource            ../actions/checks/ch_15_qualification_details_executive_bundle.robot
Resource            ../actions/checks/ch_16_institute_details.robot
Resource            ../actions/checks/ch_17_asic_personal_extract_details.robot
Resource            ../actions/checks/ch_18_vevo_details.robot



*** Test Cases ***

Scenario: Fillup Executive Bundle
    ...
    And user enter Qualification Details
    And user enter Institute Details
    And user enter ASIC Personal Extract Details
    And user enter VEVO Details
...
user enter Qualification Details
